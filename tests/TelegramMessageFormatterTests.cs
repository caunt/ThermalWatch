...
public sealed class TelegramMessageFormatterTests
{
    ...
    {
        Anomaly first = CreateAnomaly(id: "first", satellite: "Suomi-NPP");
        Anomaly[] members = multiSatellite
            ? [first, CreateAnomaly(id: "second", satellite: "NOAA-20")]
            : [first];
    ...
    {
        Anomaly anomaly = CreateAnomaly(id: "keyboard", satellite: "Suomi-NPP");
        ...
        Assert.Collection(
            ...
            googleButton =>
            {
                ...
                Assert.Equal(anomaly.GoogleMapsUrl, googleButton.Url);
            },
            yandexButton =>
            {
    ...
    {
        Anomaly representative = CreateAnomaly(id: "first", satellite: "Suomi-NPP");
        Anomaly[] members = multiSatellite
            ? [representative, CreateAnomaly(id: "second", satellite: "NOAA-20")]
            : [representative];
    ...
    private static Anomaly CreateAnomaly(string id, string satellite) =>
        new(
            id,
            CountryCode: "UKR",
