...
| [Architecture](architecture.md) | System boundaries, dependencies, data flow, state, HTTP surface, invariants, and failure isolation. Read for cross-component or integration work. | [Solution](../ThermalWatch.slnx), [composition root](../src/ThermalWatch.Api/Program.cs), [models](../src/ThermalWatch.Core/Models.cs) | A project boundary, endpoint, external integration, state model, or cross-component flow changes. |
...
| [Telegram notification flow](components/telegram-notification-flow.md) | Large vertical decision flow for Telegram inputs, clustering, filters, imagery, automatic and manual selection, and delivery. Read for any Telegram behavior change. | [Notification service](../src/ThermalWatch.Telegram/TelegramNotificationService.cs), [Telegram filters](../src/ThermalWatch.Telegram/), [clustering](../src/ThermalWatch.Core/NotificationClustering.cs), and [GIBS client](../src/ThermalWatch.Core/GibsClient.cs) | Telegram selection, clustering, filters, thresholds, imagery mapping, preview policy, formatting, ranking, state, retry, endpoint, or delivery behavior changes. |
| [Web viewer](components/web-viewer.md) | Static UI, API consumption, provider adapter contract, maps, markers, diagnostics, and browser failures. Read for viewer or map-provider work. | [Viewer controller](../src/ThermalWatch.Api/wwwroot/app.js), [host routes](../src/ThermalWatch.Api/Program.cs) | Viewer state, API consumption, provider behavior, external browser dependencies, or UI validation changes. |
