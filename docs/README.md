...
| --- | --- | --- | --- |
| [Root README](../README.md) | Product overview, safety warning, quickstart, public entry points, and links. Read for initial orientation. | [API host](../src/ThermalWatch.Api/Program.cs), [models](../src/ThermalWatch.Core/Models.cs), [configuration parsers](../src/ThermalWatch.Api/EnvironmentConfiguration.cs), and [environment setup](../.env) | User-facing capabilities or entry points change. |
